...
export default function Skills() {
  ...
  return (
    <section id="skills"
      ...
      {/* FIXED: Added py-2 and leading-tight to prevent "My Skills" from clipping */}
      <motion.h2 
        className='text-4xl mt-5 sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] z-10 py-2 leading-tight'
        ...
        >
          {repeated.map((s, i) => (
            ...
            >
              ...
              {/* Added a tiny bit of bottom padding to skill names just in case */}
